...
namespace Space_Invaders_OSBH
{
    internal class SceneRender
    {
        ...
        {
            _screenHeight = gameSettings.ConsoleHight+1;
            _screenWidth = gameSettings.ConsoleWidth+1;
            _screenMatrix = new char[gameSettings.ConsoleHight+1, gameSettings.ConsoleWidth+1];

            Console.WindowHeight = gameSettings.ConsoleHight + 1;
            Console.WindowWidth = gameSettings.ConsoleWidth + 1;
